...
This vendored copy is pinned to v1.2.2. Pop Desktop Manager changes only the Windows menu-icon conversion to preserve the alpha channel in 32-bit ARGB status icons. The upstream CreateCompatibleBitmap path renders transparent pixels as black.
