...
export const SELF_MAP = [
  ...
  "- `application/` -- use cases and ports/ (interfaces the outer layers implement) (97 modules)",
  ...
  "- `infrastructure/` -- adapters: SQLite, the pi engine, vaults on disk, embeddings (94 modules)",
  "- `interface/` -- HTTP routes (Hono) and SSE -- the outer edge (41 modules)",
