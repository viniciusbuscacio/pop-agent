...
export const SELF_MAP = [
  ...
  "- `domain/` -- entities, value objects and pure services -- the innermost layer (13 modules)",
  "- `infrastructure/` -- adapters: SQLite, the pi engine, vaults on disk, embeddings (63 modules)",
