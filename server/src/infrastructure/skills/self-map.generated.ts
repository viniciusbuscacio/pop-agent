...
export const SELF_MAP = [
  ...
  "## UI map (generated)",
  "",
  "PWA routes: /setup, /login, /recover, /chat/:chatId/artifacts, /settings/*, /, /chat/:chatId, /files, /files/trash, /files/*, /tasks, /tasks/new, /tasks/:taskId, /skills, /skills/new, /skills/:slug, /mcp, /mcp/new, /mcp/:id.",
