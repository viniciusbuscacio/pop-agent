...
export const SELF_MAP = [
  ...
  "- `application/` -- use cases and ports/ (interfaces the outer layers implement) (85 modules)",
  ...
  "- `infrastructure/` -- adapters: SQLite, the pi engine, vaults on disk, embeddings (83 modules)",
