...
export const SELF_MAP = [
  ...
  "- `application/` -- use cases and ports/ (interfaces the outer layers implement) (86 modules)",
  ...
  "- `infrastructure/` -- adapters: SQLite, the pi engine, vaults on disk, embeddings (86 modules)",
  "- `interface/` -- HTTP routes (Hono) and SSE -- the outer edge (36 modules)",
  "- `manager/` -- see docs/specs/Spec-Pop-General.md (3 modules)",
  "- `testing/` -- shared test harness helpers (1 module)",
  "",
  "## UI map (generated)",
  "",
  "PWA routes: /setup, /login, /recover, /settings/*, /, /chat/:chatId, /files, /files/trash, /files/*, /tasks, /tasks/new, /tasks/:taskId, /skills, /skills/new, /skills/:slug, /mcp, /mcp/new, /mcp/:id, /a2a, /a2a/new, /a2a/:id.",
