...
export const SELF_MAP = [
  ...
  "Settings sections: Server & Connections, Instructions, Installation, Models & Providers, Audio, Notifications, Auto-skills, Memory, Usage, Storage, Backup, Appearance, Security, About, Updates.",
