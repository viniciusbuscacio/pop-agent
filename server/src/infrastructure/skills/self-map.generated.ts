...
export const SELF_MAP = [
  ...
  "- `application/` -- use cases and ports/ (interfaces the outer layers implement) (64 modules)",
  ...
  "- `infrastructure/` -- adapters: SQLite, the pi engine, vaults on disk, embeddings (62 modules)",
  ...
  "## UI map (generated)",
  "",
  "PWA routes: /setup, /login, /recover, /chat/:chatId/artifacts, /settings/*, /, /chat/:chatId, /files, /files/trash, /files/:folderId, /tasks, /tasks/new, /tasks/:taskId, /skills, /skills/new, /skills/:slug, /mcp, /mcp/new, /mcp/:id.",
