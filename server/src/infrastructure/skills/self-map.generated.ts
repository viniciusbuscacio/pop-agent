...
export const SELF_MAP = [
  ...
  "- `application/` -- use cases and ports/ (interfaces the outer layers implement) (81 modules)",
  ...
  "- `infrastructure/` -- adapters: SQLite, the pi engine, vaults on disk, embeddings (78 modules)",
