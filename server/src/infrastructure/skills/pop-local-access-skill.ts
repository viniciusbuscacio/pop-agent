...
export const POP_LOCAL_ACCESS_SKILL: DefaultSkill = {
  ...
  body: [
    ...
    '',
    'On Windows, Pop Agent Setup offers Pop Agent Desktop and Pop Agent CLI, both selected by default. Desktop includes a WebView2 window and computer-access tray; CLI adds the pop terminal command. Desktop-only installs use a private runtime. The web window uses its own ordinary sign-in and exposes no native tool bindings. Existing components are preserved during upgrades. macOS retains the PLA/PWA arrangement.',
    '',
    '## User update flow',
    '',
