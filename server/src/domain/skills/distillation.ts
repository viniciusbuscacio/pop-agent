...
export function buildDistillPrompt(
  ...
  return [
    ...
    '- Ask whether this user has a plausible need to reuse the procedure after this conversation',
    '  and its fix are complete. Theoretical reuse by somebody is not enough. Skip one-off incidents',
    '  and product fixes already incorporated into code unless a credible recurring workflow or',
    '  independent future trigger remains.',
