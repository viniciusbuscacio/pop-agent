...
/**
 * The Skill Router (docs/specs/Spec-Pop-General.md §8): given what the user asked, pick the handful
 ...
 * same reciprocal-rank fusion the memory search uses (docs/specs/Spec-Pop-General.md §7). That
...
export interface RouteOptions {
  ...
  minZ?: number;
  /**
   * Optional embeddings (docs/specs/Spec-Pop-General.md §8): the message's vector and each skill's,
 ...
 * than guessed -- which is what docs/specs/Spec-Pop-General.md §8 asks for.
 *
 ...
 * the bridge puts them in the session's system prompt (docs/specs/Spec-Pop-General.md §8).
 */
