...
/**
 * Persistence for skills (docs/specs/Spec-Pop-General.md §8). The vault on disk is one adapter; the
...
/**
 * Retiring a skill without destroying one (docs/specs/Spec-Pop-General.md §8). Kept apart from
