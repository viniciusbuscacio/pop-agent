...
/**
 * The one provider v0.1 ships with (docs/specs/Spec-Pop-General.md §15). The id and the default
 ...
 * because one model is all Pop Agent promises to work with (docs/specs/Spec-Pop-General.md §15).
 */
