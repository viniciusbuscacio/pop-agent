...
const safeFile = /^[\w.-]+$/;
const inputPaths = [
  'cli/src', 'cli/package.json', 'cli/tsconfig.json', 'shared/src', 'shared/tsconfig.json',
  'tsconfig.base.json', 'launcher', 'local-access',
  'tools/pack-cli.ts', 'tools/pack-node-runtime.ts', 'tools/cli-pack-files.ts',
  'tools/node-runtime-release.json', 'tools/windows-setup.ts', 'tools/macos-setup.ts', 'tools/macos-tray-artifacts.ts',
];
