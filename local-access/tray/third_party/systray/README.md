...
This vendored copy is pinned to v1.2.2. Pop Local Access preserves the Windows menu-icon alpha channel in 32-bit ARGB status icons; the upstream CreateCompatibleBitmap path renders transparent pixels as black.
