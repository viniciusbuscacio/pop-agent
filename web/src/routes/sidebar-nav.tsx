...
type AgentSection = 'tasks' | 'skills' | 'mcp' | 'a2a' | 'rest-api';
...
export function SidebarNav() {
  ...
  // 03/08).
  const AGENT_SECTIONS: AgentSection[] = ['tasks', 'skills', 'mcp', 'a2a', 'rest-api'];
      ...
      {mainSection === 'agent' && agentSection !== undefined ? (
        <Segmented<AgentSection>
          ...
          options={[
            ...
            { value: 'rest-api', label: 'REST API', testId: 'sidebar-rest-api' },
          ]}
        />
      ) : null}
    </div>
