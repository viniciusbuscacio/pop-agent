...
export const en = {
  ...
  'chat.queued': 'After this run: {text}',
  'chat.steering': 'Guiding this run: {text}',
  ...
  'skills.activity.body': 'Why each conversation produced a skill, a rewrite, nothing, or a failure.',
  ...
  'skills.activity.result.skipped_user': 'matched a personal skill, so it was not changed',
