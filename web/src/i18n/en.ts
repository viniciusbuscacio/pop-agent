...
export const en = {
  ...
  'settings.updates.deviceSubtitle': 'The Pop Agent interface installed on this device.',
  'settings.updates.appType': 'App',
  'settings.updates.localVersion': 'Local version',
  'settings.updates.checkAndUpdate': 'Check and update',
  'settings.updates.automaticChecks': 'Automatic checks',
  'settings.updates.deviceNote': 'Checks and installs the newest PWA only on this device.',
  'settings.updates.yourServer': 'Your server',
  'settings.updates.serverSubtitle': 'The Pop Agent process running on your Linux server.',
  ...
  'settings.updates.current': 'This PWA is up to date.',
