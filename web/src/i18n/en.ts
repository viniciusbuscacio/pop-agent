...
export const en = {
  ...
  'setup.done.body': 'Popy is ready. The chat arrives in the next version.',
  ...
  'shell.empty.body': 'Conversations arrive in the next version. The foundation is in place.',
