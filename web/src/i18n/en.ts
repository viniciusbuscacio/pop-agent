...
export const en = {
  ...
  'settings.updates.checkAutomaticallyHint': 'Looks for a newer app build on this device.',
  'settings.updates.checkFrequency': 'Check frequency',
  ...
  'settings.updates.autoActivateHint':
    'Only prepared updates that passed the gate can activate automatically.',
