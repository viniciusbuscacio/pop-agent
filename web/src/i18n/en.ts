...
export const en = {
  ...
  'app.name': 'Pop Agent',
  'context.startConversation': 'Start conversation',
  'context.messagePrompt': 'Message to {name}:',
  'context.testPassed': 'Connection test passed.',
  'context.new': 'New',
  'context.test': 'Test connection',
  'context.actions': 'Actions',
  'context.failed': 'The action could not be completed. Try again.',
  'context.copySelection': 'Copy selection',
  'context.copyMessage': 'Copy message',
  'context.quote': 'Quote in message',
  ...
  'shell.refreshFailed': 'Some data could not be refreshed. Saved content is still available. Try again.',
  'shell.cacheLimited': 'Browser storage is limited. Some conversations may need a connection to reopen.',
  ...
  'settings.section.installation': 'Install Pop',
  'settings.section.devices': 'Devices',
  'settings.devices.intro': 'Turn on access to let Pop Agent use files and run commands on that computer from this browser. Choose one computer at a time.',
  'settings.installation.webLinux': 'Linux: in Chrome or a compatible browser, open the browser menu and choose Install Pop Agent or Install app.',
  'settings.devices.remove': 'Remove computer',
  'settings.devices.removeConfirm': 'Remove “{name}” and revoke its local access? To reconnect, sign in again with pop login and restart Pop Local Access.',
  'settings.devices.usingComputer': 'Using {name}',
  'settings.devices.accessFailed': 'Computer access could not be applied. Try again.',
  'settings.devices.removeFailed': 'The computer could not be removed. Try again.',
  'settings.devices.connect': 'Connect a computer',
  'settings.installation.platform': 'Device to install on',
  'settings.installation.cliDesktopOnly': 'The command-line app runs on Windows, macOS and Linux. Choose a computer above to see its installation command.',
  ...
  'settings.installation.localAccessForMachine': 'Allow access to this computer',
  ...
  'settings.installation.localAccessServerOnly': 'Server only',
  ...
  'settings.breadcrumbs': 'Settings navigation',
  'settings.server.shutdown': 'Shut down server…',
  'settings.server.unknown': 'Response status is unavailable. Reload to check again.',
  'settings.server.running': 'Responses are enabled.',
  'settings.server.paused': 'Responses are paused. Resume to accept messages again.',
  'settings.server.actionFailed': 'Could not confirm this action. Check the server connection before trying again.',
  'settings.server.actionDone': 'Action accepted.',
  'settings.server.llmRestartConfirm': 'Reset AI sessions? This can interrupt active responses. Saved conversations are kept.',
  'settings.server.restart': 'Restart Pop Agent',
  'settings.server.stop': 'Shut down Pop Agent',
  'settings.server.llmStop': 'Pause responses',
  'settings.server.llmStart': 'Resume responses',
  'settings.server.llmRestart': 'Reset AI sessions',
  'settings.server.dangerService': 'Pop Agent server',
  'settings.server.dangerLlm': 'AI responses',
  'settings.server.restartHint': 'Temporarily disconnects all devices and interrupts active work. The service restarts automatically.',
  'settings.server.stopHint':
    'Takes the app offline until you connect to the server over SSH and run popman start. You cannot turn it back on from this page.',
  'settings.server.llmStopHint':
    'Interrupts active responses and blocks new ones. Files, settings and saved conversations remain available.',
  'settings.server.llmStartHint': 'Allows new responses again. Interrupted responses do not resume automatically.',
  'settings.server.llmRestartHint':
    'Recreates AI sessions on the next message and may interrupt active responses. Saved conversations are kept.',
  ...
  'settings.server.llmStopConfirm': 'Pause AI responses? Active responses will stop and new ones will be blocked until you resume. The app stays available.',
  ...
  'provider.models.refresh': 'Refresh models',
  'provider.models.refreshing': 'Refreshing models…',
  'provider.models.refreshed': 'Model list refreshed.',
  'provider.models.failed': 'Could not refresh models. Your previous list and selections were kept.',
  ...
  'backup.privacy': 'New backups are encrypted with your backup password. Older unencrypted archives remain sensitive and should be stored securely.',
  'backup.passwordSaved': "Backup password saved securely for future backups.",
  'backup.passwordMissing': "Set a separate backup password before creating your first encrypted backup.",
  'backup.password': "Backup password",
  'backup.confirmation': "Confirm backup password",
  'backup.passwordNotice': "This password is independent of your app password and is saved encrypted on this server for future backups. Keep a copy elsewhere: restoring requires the password used when the backup was created. Changing it affects only new backups.",
  'backup.savePassword': "Save backup password",
  'backup.cancel': "Cancel",
  'backup.setPassword': "Set backup password",
  'backup.changePassword': "Change backup password",
  'backup.passwordInvalid': "Use matching passwords of 10–128 characters.",
  'backup.passwordFailed': "Could not save the backup password.",
  'backup.encrypted': "Encrypted",
  'backup.legacy': "Legacy — not encrypted",
  'backup.intro': 'Back up your data or restore a saved snapshot. Downloadable voice and search models are excluded. Restoring restarts Pop Agent automatically.',
  'backup.includeFiles': 'Include files',
  'backup.includeFilesHint': 'Include all files and subfolders from Files. Conversations, settings, skills and notes are always included.',
  'backup.withFiles': 'Includes Files',
  'backup.withoutFiles': 'Without Files',
  'backup.restoreWithoutFilesNotice': 'Conversations, settings, skills and notes will be restored. Existing Files on this server will be kept. Files and attachments are not included in this archive. Running conversations will stop; you may need to sign in again.',
  'backup.create': 'Create encrypted backup',
  'backup.creating': 'Creating…',
  'backup.download': 'Download',
  'backup.restore': 'Restore',
  'backup.restoreConfirm': 'Restore “{name}”? This replaces current data and interrupts running conversations.',
  'backup.restored': 'Backup restored. You may need to sign in again.',
  'backup.background': 'Creating an encrypted backup in the background. You can leave this page. Large backups can take several minutes; keep the server running.',
  'backup.preparing': 'Validating and preparing your backup in the background. You can leave this page. Pop Agent will restart when it is ready.',
  'backup.restarting': 'Restarting to restore your backup. Reconnect when the server is ready; you may need to sign in again.',
  'backup.restoreTitle': 'Restore {name}',
  'backup.restoreNotice': 'Current conversations, files and settings will be replaced by this snapshot. Running conversations will stop. Previous data is kept on the server for recovery. You may need to sign in with the password from the backup.',
  'backup.archivePassword': 'Password used for this backup',
  'backup.restoreNow': 'Restore and restart',
  'backup.restoreFailed': 'Restore could not be started. Reload the list and try again.',
  ...
  'skills.filter.auto': 'Auto-Skills',
  ...
  'provider.serviceModelHint':
    'Used for titles, summaries, and voice cleanup.',
  ...
  'provider.oauth.reconnect': 'Reconnect',
  ...
  'files.textContent': 'Text content',
  'files.discardEdits': 'Discard your unsaved changes?',
  'files.editFailed': 'Could not save. Your edits were kept; try again.',
  'files.editConflict': 'This file changed elsewhere. Your edits were kept. Copy them before reopening the latest version.',
  'files.editTooLarge': 'The text editor supports UTF-8 files up to 1 MB.',
  'files.select': 'Select',
  'files.deleteFailed': '{count} item(s) could not be moved to Trash. They remain selected; try again.',
  'files.refreshFailed': 'Could not refresh the file list. Refresh to see the latest changes.',
  ...
  'files.pdfPageCount': '{page} of {count}',
  'files.source': 'Source',
  ...
  'settings.updates.availableUpdate': 'Published update',
  'settings.updates.notChecked': 'Not checked yet',
  'settings.updates.checkFailed': 'Check failed — try again',
  'settings.updates.checkUnavailableRelease': 'Could not verify the latest release',
  'settings.updates.validationRequired': 'Update needs validation',
  'settings.updates.validationHint': 'A new server build is present, but it must pass validation before it can be applied.',
  'settings.updates.technicalDetails': 'Technical details',
  'settings.updates.piDescription': 'Pi agent is the AI engine used by Pop Agent to run conversations and tools. It is separate from your selected models and providers.',
  'settings.updates.none': 'None',
  'settings.updates.checkServerUpdates': 'Check for server updates',
  'settings.updates.aiRuntime': 'Pi agent',
  ...
  'settings.updates.piActive': 'Installed version',
  ...
  'settings.updates.piPrepare': 'Prepare Pi agent update',
  ...
  'settings.updates.piActivateConfirm': 'Apply this validated Pi agent update when work is idle? The server will restart.',
  ...
  'settings.updates.restartWhenIdle': 'Apply prepared update',
  ...
  'settings.updates.status.current': 'Running installed build',
  ...
  'settings.updates.status.healthy': 'Update applied successfully',
