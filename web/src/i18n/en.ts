...
export const en = {
  ...
  'skills.activity.title': 'Learning activity',
  ...
  'skills.activity.queued': 'Queued',
  'skills.activity.running': 'Looking now',
  'skills.activity.produced': 'Produced',
  'skills.activity.nothing': 'Nothing to learn',
  'skills.activity.tainted': 'Tainted',
  'skills.activity.invalid': 'Invalid answer',
  'skills.activity.failed': 'Failed',
  'skills.activity.queuedNote': 'This exact conversation window will be tried on the next distiller pass.',
  'skills.activity.runningNote': 'Pop Agent is inspecting this conversation window now.',
  'skills.activity.nothingNote': 'The model found no complete, reusable procedure.',
  'skills.activity.taintedNote': 'External content was blocked by the local safety check ({level}).',
  'skills.activity.producedNote': 'This pass produced {count} result(s).',
  'skills.activity.retry': 'Try again',
  'skills.activity.queueing': 'Queueing…',
  'skills.activity.slugCollision': 'same slug',
  'skills.activity.dedupMatch': 'semantic and vocabulary match',
  'skills.activity.result.pending': 'new skill waiting for approval',
  'skills.activity.result.live': 'new skill accepted automatically',
