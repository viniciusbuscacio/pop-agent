...
uses compact 0.25rem outer horizontal insets (or the device safe-area inset,
whichever is larger) to give the message box more width without changing its
height or shrinking the action buttons.
